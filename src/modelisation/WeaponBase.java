...
public class WeaponBase {
	...
	public static final int NUMITM = 5;
	...
	static {
        ...
        templates.add(new Weapon("Shield", 1, 0,false,List.<Coord>of(new Coord(0,0),new Coord(0,1),new Coord(1,0),new Coord(1,1)),List.<Effect>of(new Effect_Def(10)),"./image/weapons/shield.png",(h,c)->h.interhp(c*5),15));
        ...
        templates.add(new Weapon("Potion", 0, 0,true,List.<Coord>of(new Coord(0,0),new Coord(0,1)),List.<Effect>of(new Effect_Heal(10)),"./image/weapons/potion.png",(h,c)->{},5));
	}
}
