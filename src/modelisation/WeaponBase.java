...
public class WeaponBase {
	...
	static {
        templates.add(new Weapon("Durandal", 2, 5,false,List.<Coord>of(new Coord(0,0),new Coord(0,1),new Coord(0,2)),List.<Effect>of(new Effect_Puncture(12, 4), new Effect_Heal(4)),"./image/weapons/durantal.png")); // name, cost, manacost, estconsomme, listforme, listeffect
